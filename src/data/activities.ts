...
export const activities: Activity[] = [
  {
    ...
    lead: [
      "Open Mic Japan の中心にあるのは、ジャンルや経験で線を引かないオープンマイクの場づくりです。",
  ...
  },
  {
    ...
    examples: [
      ...
      {
        title: "ワークショップ「さらけだし」",
        body: "自分の中の表現を「さらけ出す」ための場。協力拠点 SOY-POY での企画として 2021 年から継続。",
      },
    ],
  ...
  },
  {
    ...
    summary:
      "下北沢を拠点にしながら、茅ヶ崎・青野原などの神奈川県、そして山梨県・平林（毎年5月の「宴」）と、地域での開催を重ねています。",
    lead: [
      "下北沢を拠点にしながら、神奈川県（茅ヶ崎・青野原など）、山梨県（毎年5月の野外イベント「宴」）と、地域での開催を積み重ねてきました。",
    ...
    examples: [
      {
        title: "野外イベント「宴」（山梨県・平林）",
        body: "毎年5月、山梨県・平林で開催する野外イベント。表現と小商いが同時に立ち上がる場として、地域での実践の中心になってきました。次回は 2026年5月23日〜24日。",
      },
      {
        title: "茅ヶ崎での開催（神奈川県）",
        body: "2025年3月、茅ヶ崎で開催。神奈川県内での連携実績の一つ。",
      },
      {
        title: "青野原での開催（神奈川県）",
        body: "2025年5月、青野原（神奈川県相模原市）にて。下北沢のメンバーと地域の方々で「出遊（しゅつゆう）」企画として実施。",
      },
    ],
    stats: [{ number: "2県+", label: "開催地域（神奈川・山梨ほか）" }],
