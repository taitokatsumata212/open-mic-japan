...
export const activities: Activity[] = [
  ...
  },
  {
    ...
    examples: [
      {
        title: "野外イベント「宴」",
        body: "毎年5月開催。出演と出店が同時に立ち上がる、小さなフェスのような場。茅ヶ崎・青野原などの地域開催も継続。",
      },
      {
        title: "協力拠点での企画イベント",
  ...
  },
  {
    ...
    summary:
      "下北沢を拠点にしながら、茅ヶ崎・青野原など神奈川県内での開催経験を重ねています。",
    lead: [
    ...
    examples: [
      ...
      {
        title: "地方イベント案件への関与",
        body: "個別の地方イベント運営・企画への関わりを継続。Phase 3 では地域拠点・自治体との連携を強化していきます。",
      },
    ],
    stats: [{ number: "3エリア+", label: "開催地域（東京・神奈川など）" }],
